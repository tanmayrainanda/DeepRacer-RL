#still building up on model 3, trynna make it faster
#45.273 but veers off track wayyy too much
...
def reward_function(params):
    ...
    TURN_SPEED = 2.5      # Target speed for normal turns
    SHARP_TURN_SPEED = 1.5  # Target speed for sharp turns
